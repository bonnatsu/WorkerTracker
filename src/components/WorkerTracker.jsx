  ...
  return (
    <div className="layout">
        <div className="header">
          <h2>Work Tracker</h2>
          {/* 戻る（共通） */}
          {(selectedCategory || selectedSubCategory || mode !== "main") && (
              ...
              <div className="active_list">
                ...
                {activeWorks.map((work) => (
                  <div key={work.id} className="active-item">
                    {work.employee_id}:{work.employee_name}　:{work.category} ＞ {work.subcategory}　開始時間：{formatJST(work.start_time)}
                  </div>
                ))}
              </div>
            )}
